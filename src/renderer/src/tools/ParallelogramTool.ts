...
class ParallelogramDrawing extends StateNode {
  ...
  private complete() {
    if (this.shapeId) {
      ...
      if (shape && shape.type === 'custom-parallelogram') {
...
class ParallelogramIdle extends StateNode {
...
export class ParallelogramTool extends StateNode {
  static override id = 'custom-parallelogram'
  static override initial = 'idle'
  static override children = () => [ParallelogramIdle, ParallelogramDrawing]
